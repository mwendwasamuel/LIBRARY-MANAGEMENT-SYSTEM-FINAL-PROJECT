            ...
            <div>
                ...
                <div className="row footer">
                    ...
                    <div className="col-sm-4">
                        ...
                        <h6>Samuel Mbula</h6>
                        <h6>Elijah</h6>
                        <p className="deve"> <a href="https://www.facebook.com/Asherleeky?mibextid=ZbWKwL"> <i className="fab fa-facebook-square"></i> </a> </p>
                        <p className="deve"> <a href="https://twitter.com/LeekyAsher"> <i className="fab fa-twitter-square"></i> </a> </p>
                    </div>
                </div>
            </div>
        );
